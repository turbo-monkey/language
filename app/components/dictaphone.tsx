...
const Dictaphone = ({
  ...
  return (
    <div>
      <Text size="$3xl">Jouw antwoord: {transcript}</Text>
      <Spacer />
      <Grid.Container gap={1}>
        <Grid>
          <Tooltip content="Klik om de opname te starten">
            <Button
              css={{ minWidth: 100 }}
              shadow
              auto
        ...
        <Spacer x={1} />
        <Grid>
          <Tooltip content="Klik om de opname te stoppen">
            <Button
              css={{ width: 100 }}
              shadow
              size="lg"
